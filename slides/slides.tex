...
\begin{frame}{Scacchiera: Il caso limite F=10}
    \begin{itemize}
        ...
        \item L'energia spaziale si concentra unicamente nella componente continua, permettendo una compressione perfetta al minimo della soglia ($d=1$).
    \end{itemize}
\end{frame}

\begin{frame}{Scacchiera: Compressione perfetta con F=10 ($d=1$)}
    \begin{figure}
        \centering
        \begin{minipage}{0.32\textwidth}
            \centering
            \includegraphics[width=\textwidth]{../relazione/figures/20x20_grid_F10.png}
            
            \vspace{2mm}
            \scriptsize $20\times20$
        \end{minipage}
        \hfill
        \begin{minipage}{0.32\textwidth}
            \centering
            \includegraphics[width=\textwidth]{../relazione/figures/160x160_grid_F10.png}
            
            \vspace{2mm}
            \scriptsize $160\times160$
        \end{minipage}
        \hfill
        \begin{minipage}{0.32\textwidth}
            \centering
            \includegraphics[width=\textwidth]{../relazione/figures/640x640_grid_F10.png}
            
            \vspace{2mm}
            \scriptsize $640\times640$
        \end{minipage}
    \end{figure}
\end{frame}
...
\begin{frame}{Conclusioni e Discussione Finale}
    \begin{itemize}
        \item I segnali lisci si prestano perfettamente alla DCT permettendo un'enorme compressione senza perdite.
        \item Sulle fotografie naturali si ottiene un'ottima riduzione dei dati mantenendo alta la qualità visiva.
        \item L'algoritmo risulta invece del tutto inefficace su pattern densi ad alta frequenza.
        \item Le compressioni estreme generano artefatti di ringing sui bordi netti e griglie visibili tra i blocchi.
    \end{itemize}
\end{frame}
